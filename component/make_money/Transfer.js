...
export default class Transfer extends Component {
  ...
  render() {
    ...
    const {
      ...
      imgInfo,colorTitle,wrapContent,wrapInput,btnTransfer,btnFinish,
    ...
    return (
      ...
      <ScrollView >
        <View style={contentWrap}>
            ...
            <View style={marTop}>
            <Text style={colorTitle}>Nhập số Kcoin muốn chuyển đi</Text>
              <TextInput underlineColorAndroid='transparent'
              returnKeyType = {"next"}
              autoFocus = {true}
              onSubmitEditing={(event) => {  this.refs.tk.focus();  }}
            ...
            <View style={marTop}>
              <Text style={colorTitle}>Tài khoản nhận tiền</Text>
              <TextInput underlineColorAndroid='transparent'
              returnKeyType = {"next"}
              ref='tk'
              ...
              <Text style={{marginTop:5,color:'#777E8A'}}>* Nhập số điện thoại của người nhận</Text>

            </View>

            <View style={marTop}>
              <Text style={colorTitle}>Nhập code</Text>
              <TextInput underlineColorAndroid='transparent'
              returnKeyType = {"next"}
              ref='code'
              onSubmitEditing={(event) => {  this.refs.nd.focus();  }}
              placeholder={''} style={wrapInput}
              onChangeText={(txtName) => this.setState({txtName})}
              />
            </View>
            ...
            <View style={marTop}>
              <Text style={colorTitle}>Mục đích chuyển</Text>
              <TextInput underlineColorAndroid='transparent'
              returnKeyType = {"done"}
              ref='nd'
              placeholder={''} style={wrapInput}
            ...
            <TouchableOpacity onPress={()=>this.setState({showCode:true})} style={[marTop,btnTransfer]}>
              <Text style={titleCreate}>{`${'Chuyển tiền'}`.toUpperCase()}</Text>
            </TouchableOpacity>
        ...
        <View style={popoverLoc}>
            <View style={[overLayout]}>
              <Text style={titleVer}>{`${'Xác nhận chuyển điểm'}`.toUpperCase()}</Text>
